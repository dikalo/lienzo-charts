...
public class BarChart extends AbstractChart<BarChart>
{
    ...
    private abstract class BarChartBuilder<T extends BarChartBuilder<T>>
    {
        ...
        final List<Text>                   seriesLabels          = new LinkedList<Text>();                      // The labels for each interval (rectangle) in the X axis.
                ...
                for (int i = 0; i < categoryAxisValues.size(); i++)
                {
                    ...
                    barObject.addNodeDragEndHandler(new NodeDragEndHandler()
                    {
                        ...
                        public void onNodeDragEnd(NodeDragEndEvent nodeDragEndEvent)
                        {
                            ...
                            if (x < chartArea.getX() || x > (chartArea.getX() + getChartWidth()) || y < chartArea.getY() || y > (chartArea.getY() + getChartHeight()))
                            {
